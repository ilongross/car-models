...
public class LoggingAspect {
    ...
    @AfterReturning("loggingCarModel() && loggingClassifiedCarModel()")
    ...
    @Pointcut("@annotation(com.ilongross.consumer_service.aspect.LoggingClassifiedCarModel)")
    public void loggingClassifiedCarModel() {
    }
